...
/* harmony import */ var _utils_helper__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../utils/helper */ "./src/utils/helper.ts");
...
var ScatterChart = /*#__PURE__*/function () {
  function ScatterChart(wrapper, options) {
    ...
    this.width = 0;
    this.height = 0;
    this.padding = _constants_ui__WEBPACK_IMPORTED_MODULE_27__.CONTAINER_PADDING;
    this.t0 = 0;
    this.reqAnimation = 0;
  ...
  _createClass(ScatterChart, [{
    ...
    value: function setPadding() {
      ...
      var xTicks = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_32__.getTickTexts)(this.options.axis.x);
      var yTicks = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_32__.getTickTexts)(this.options.axis.y);
      var maxXTickTextWidth = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_32__.getLongestTextWidth)(xTicks, function (t) {
        return _this.viewport.viewLayer.getTextWidth(t);
      });
      var maxYTickTextWidth = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_32__.getLongestTextWidth)(yTicks, function (t) {
        return _this.viewport.viewLayer.getTextWidth(t);
      });
      var formattedXSample = xformatter ? xformatter(this.options.axis.x.max) : this.options.axis.x.max;
      this.padding.left = (maxXTickTextWidth / 2 > maxYTickTextWidth ? maxXTickTextWidth / 2 : maxYTickTextWidth) + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.TEXT_MARGIN_LEFT + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.TEXT_MARGIN_RIGHT + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.AXIS_TICK_LENGTH;
      this.padding.right = maxXTickTextWidth / 2 + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.TEXT_MARGIN_RIGHT;
      this.padding.bottom = this.viewport.viewLayer.getTextHeight(formattedXSample) + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.TEXT_MARGIN_TOP + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.TEXT_MARGIN_BOTTOM + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.AXIS_TICK_LENGTH;
    }
  }, {
    key: "setViewPort",
    ...
    value: function shoot() {
      ...
      this.viewport.clear();
      (0,_utils_draw__WEBPACK_IMPORTED_MODULE_24__.drawRect)(this.viewport.context, 0, 0, this.width, this.height);
    ...
    value: function render(data) {
      ...
      data.forEach(function (_ref4) {
        ...
        if (!_this6.dataLayers[legend]) {
          _this6.setLayer(legend, styleWidth, styleHeight, _constants_ui__WEBPACK_IMPORTED_MODULE_27__.LAYER_DEFAULT_PRIORITY);
        }
        ...
        !hidden && (0,_utils_draw__WEBPACK_IMPORTED_MODULE_24__.drawCircle)(_this6.dataLayers[legend].context, _this6.xRatio * x + padding.left + _constants_ui__WEBPACK_IMPORTED_MODULE_27__.AXIS_INNER_PADDING, _this6.viewport.canvas.height / _this6.viewport.viewLayer.dpr - _this6.yRatio * y - padding.bottom - _constants_ui__WEBPACK_IMPORTED_MODULE_27__.AXIS_INNER_PADDING, {
    ...
    value: function toBase64Image() {
      this.viewport.setSize(_constants_ui__WEBPACK_IMPORTED_MODULE_27__.CONTAINER_WIDTH, _constants_ui__WEBPACK_IMPORTED_MODULE_27__.CONTAINER_HEIGHT).render(0, 0); // const layer = new Layer({ width: this.width , height: this.height});
...
//# sourceMappingURL=main.c647b6d25c7736d3d855.hot-update.js.map