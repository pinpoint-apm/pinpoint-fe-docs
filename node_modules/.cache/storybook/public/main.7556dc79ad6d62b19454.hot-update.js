          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return html2canvas__WEBPACK_IMPORTED_MODULE_44___default()(document.querySelector("." + ScatterChart.SCATTER_CHART_CLASS)).then(function (canvas) {
                  return canvas;
                });
              ...
              case 3:
                ...
                _context.next = 6;
                return html2canvas__WEBPACK_IMPORTED_MODULE_44___default()(document.querySelector("." + _Legend__WEBPACK_IMPORTED_MODULE_40__.Legend.LEGEND_WARPPER_CLASS)).then(function (canvas) {
                  return canvas;
                });

              case 6:
                legendCanvas = _context.sent;
                layer.setSize(containerCanvas.width, containerCanvas.height + legendCanvas.height); // layer.context.drawImage(containerCanvas, 0,0);

                layer.context.drawImage(legendCanvas, 0, 0);
...
ScatterChart.SCATTER_CHART_CLASS = _constants_ui__WEBPACK_IMPORTED_MODULE_38__.SCATTER_CHART_IDENTIFIER + "container";

/***/ })

});
//# sourceMappingURL=main.7556dc79ad6d62b19454.hot-update.js.map