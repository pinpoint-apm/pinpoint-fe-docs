...
var ScatterChart = /*#__PURE__*/function () {
  ...
  _createClass(ScatterChart, [{
    ...
    key: "startRealtime",
    value: function startRealtime(duration) {
      var _axisOptions$x$tick, _axisOptions$x$tick2;

      if (this.reqAnimation) return;
      var axisOptions = this.options.axis;
      this.xAxis.setTickCount(((_axisOptions$x$tick = axisOptions.x.tick) === null || _axisOptions$x$tick === void 0 ? void 0 : _axisOptions$x$tick.count) * 2 - 1).setSize(this.width * 2 - this.padding.left - _constants_ui__WEBPACK_IMPORTED_MODULE_27__.AXIS_INNER_PADDING * 2 - this.padding.right, this.height).setMinMax(axisOptions.x.min, axisOptions.x.max * 2 - axisOptions.x.min).render();
      this.realtimeAxisMinX = axisOptions.x.min;
      this.realtimeAxisMaxX = axisOptions.x.max * 2 - axisOptions.x.min;
      this.gridAxis.setXTickCount(((_axisOptions$x$tick2 = axisOptions.x.tick) === null || _axisOptions$x$tick2 === void 0 ? void 0 : _axisOptions$x$tick2.count) * 2 - 1).setSize(this.width * 2 - this.padding.left - _constants_ui__WEBPACK_IMPORTED_MODULE_27__.AXIS_INNER_PADDING * 2 - this.padding.right, this.height).render();
      this.animate(duration, this.t0);
    }
  }, {
    key: "stopRealtime",
    value: function stopRealtime() {
      var _axisOptions$x$tick3, _axisOptions$x$tick4;
      ...
      this.coordX = 0;
      this.t0 = 0;
      this.xAxis.setTickCount((_axisOptions$x$tick3 = axisOptions.x.tick) === null || _axisOptions$x$tick3 === void 0 ? void 0 : _axisOptions$x$tick3.count).setSize(this.width, this.height).setMinMax(axisOptions.x.min, axisOptions.x.max).render();
      this.realtimeAxisMinX = axisOptions.x.min;
      this.realtimeAxisMaxX = axisOptions.x.max;
      this.guide.updateXAxis({
        min: axisOptions.x.min
      });
      this.gridAxis.setXTickCount((_axisOptions$x$tick4 = axisOptions.x.tick) === null || _axisOptions$x$tick4 === void 0 ? void 0 : _axisOptions$x$tick4.count).setSize(this.width, this.height).render();
      this.shoot();
    }
  }]);
...
//# sourceMappingURL=main.02e30eeda2f0d165fe7e.hot-update.js.map