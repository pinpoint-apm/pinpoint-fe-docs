...
var ScatterChart = /*#__PURE__*/function () {
  ...
  _createClass(ScatterChart, [{
    ...
    value: function resize(width, height) {
      ...
      this.wrapper.style.height = height + "px"; // this.viewport.setSize(width, height);

      this.guide.setSize(width, height);
      this.xAxis.setSize(width, height);
      this.yAxis.setSize(width, height);
      Object.values(this.layers).forEach(function (layer) {
        return layer.setSize(width, height);
      });
      this.shoot();
...
//# sourceMappingURL=main.f2d8ede4cbda3e9f054f.hot-update.js.map