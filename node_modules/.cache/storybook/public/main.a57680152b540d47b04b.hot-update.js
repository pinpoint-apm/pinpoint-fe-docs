...
/* harmony import */ var lodash_clonedeep__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! lodash.clonedeep */ "../../node_modules/lodash.clonedeep/index.js");
/* harmony import */ var lodash_clonedeep__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(lodash_clonedeep__WEBPACK_IMPORTED_MODULE_22__);
/* harmony import */ var _Layer__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./Layer */ "./src/ui/Layer.ts");
/* harmony import */ var _Viewport__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./Viewport */ "./src/ui/Viewport.ts");
/* harmony import */ var _utils_draw__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../utils/draw */ "./src/utils/draw.ts");
/* harmony import */ var _YAxis__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./YAxis */ "./src/ui/YAxis.ts");
/* harmony import */ var _XAxis__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./XAxis */ "./src/ui/XAxis.ts");
/* harmony import */ var _constants_ui__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../constants/ui */ "./src/constants/ui.ts");
/* harmony import */ var _GridAxis__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./GridAxis */ "./src/ui/GridAxis.ts");
/* harmony import */ var _Legend__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./Legend */ "./src/ui/Legend.ts");
/* harmony import */ var _Guide__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./Guide */ "./src/ui/Guide.ts");
/* harmony import */ var _constants_options__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../constants/options */ "./src/constants/options.ts");
/* harmony import */ var _utils_helper__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../utils/helper */ "./src/utils/helper.ts");
...
var ScatterChart = /*#__PURE__*/function () {
  function ScatterChart(wrapper, options) {
    ...
    this.width = 0;
    this.height = 0;
    this.padding = _constants_ui__WEBPACK_IMPORTED_MODULE_28__.CONTAINER_PADDING;
    this.t0 = 0;
    this.reqAnimation = 0;
  ...
  _createClass(ScatterChart, [{
    ...
    value: function setOptions(options) {
      this.options = {
        // TODO deep copy
        axis: lodash_merge__WEBPACK_IMPORTED_MODULE_21___default()(_constants_options__WEBPACK_IMPORTED_MODULE_32__.defaultAxisOption, options.axis),
        data: [].concat(_toConsumableArray(_constants_options__WEBPACK_IMPORTED_MODULE_32__.defaultDataOption), _toConsumableArray(options.data)),
        legend: lodash_merge__WEBPACK_IMPORTED_MODULE_21___default()(_constants_options__WEBPACK_IMPORTED_MODULE_32__.defaultLegendOption, options.legend)
      };
    ...
    value: function setWidthAndHeight() {
      this.width = this.canvasWrapper.clientWidth || _constants_ui__WEBPACK_IMPORTED_MODULE_28__.CONTAINER_WIDTH;
      this.height = this.canvasWrapper.clientHeight || _constants_ui__WEBPACK_IMPORTED_MODULE_28__.CONTAINER_HEIGHT;
    }
  }, {
    key: "setPadding",
    value: function setPadding() {
      ...
      var xTicks = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_33__.getTickTexts)(this.options.axis.x);
      var yTicks = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_33__.getTickTexts)(this.options.axis.y);
      var maxXTickTextWidth = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_33__.getLongestTextWidth)(xTicks, function (t) {
        return _this.viewport.viewLayer.getTextWidth(t);
      });
      var maxYTickTextWidth = (0,_utils_helper__WEBPACK_IMPORTED_MODULE_33__.getLongestTextWidth)(yTicks, function (t) {
        return _this.viewport.viewLayer.getTextWidth(t);
      });
      var formattedXSample = xformatter ? xformatter(this.options.axis.x.max) : this.options.axis.x.max;
      this.padding.left = (maxXTickTextWidth / 2 > maxYTickTextWidth ? maxXTickTextWidth / 2 : maxYTickTextWidth) + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.TEXT_MARGIN_LEFT + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.TEXT_MARGIN_RIGHT + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_TICK_LENGTH;
      this.padding.right = maxXTickTextWidth / 2 + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.TEXT_MARGIN_RIGHT;
      this.padding.bottom = this.viewport.viewLayer.getTextHeight(formattedXSample) + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.TEXT_MARGIN_TOP + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.TEXT_MARGIN_BOTTOM + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_TICK_LENGTH;
    }
  }, {
    key: "setViewPort",
    value: function setViewPort() {
      this.viewport = new _Viewport__WEBPACK_IMPORTED_MODULE_24__.Viewport(this.canvasWrapper, {
        width: this.width,
        height: this.height
      });
    }
    ...
    value: function setGuide() {
      this.guide = new _Guide__WEBPACK_IMPORTED_MODULE_31__.Guide(this.canvasWrapper, {
        width: this.width,
        height: this.height,
    ...
    value: function setAxis() {
      ...
      this.yAxis = new _YAxis__WEBPACK_IMPORTED_MODULE_26__.YAxis({
      ...
      this.xAxis = new _XAxis__WEBPACK_IMPORTED_MODULE_27__.XAxis({
      ...
      this.gridAxis = new _GridAxis__WEBPACK_IMPORTED_MODULE_29__.GridAxis({
        width: this.width,
        height: this.height,
        padding: this.padding,
        priority: 9999,
    ...
    value: function setLayers() {
      ...
      dataOptions.forEach(function (_ref) {
        var type = _ref.type,
            ...
            priority = _ref$priority === void 0 ? _constants_ui__WEBPACK_IMPORTED_MODULE_28__.LAYER_DEFAULT_PRIORITY : _ref$priority;
    ...
    value: function setLayer(legend, width, height, priority) {
      var layer = new _Layer__WEBPACK_IMPORTED_MODULE_23__.Layer({
        width: width,
        height: height
      });
      layer.id = legend;
    ...
    value: function setLegends() {
      ...
      this.legend = new _Legend__WEBPACK_IMPORTED_MODULE_30__.Legend(this.wrapper, {
    ...
    value: function setRatio() {
      ...
      var minY = axis.y.min;
      var maxY = axis.y.max;
      this.xRatio = (width - padding.left - padding.right - _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_INNER_PADDING * 2) / (maxX - minX);
      this.yRatio = (height - padding.bottom - padding.top - _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_INNER_PADDING * 2) / (maxY - minY);
    }
  }, {
    key: "shoot",
    value: function shoot() {
      ...
      this.viewport.clear();
      (0,_utils_draw__WEBPACK_IMPORTED_MODULE_25__.drawRect)(this.viewport.context, 0, 0, this.width, this.height);
    ...
    value: function animate(duration, now) {
      ...
      var dt = now - this.t0;
      var pixcelPerFrame = (this.viewport.styleWidth - this.padding.left - this.padding.right - _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_INNER_PADDING * 2) / duration * dt;
      ...
      if (this.coordX > -(this.viewport.styleWidth - this.padding.left - this.padding.right - _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_INNER_PADDING * 2)) {
    ...
    value: function render(data) {
      ...
      data.forEach(function (_ref4) {
        ...
        if (!_this6.dataLayers[legend]) {
          _this6.setLayer(legend, styleWidth, styleHeight, _constants_ui__WEBPACK_IMPORTED_MODULE_28__.LAYER_DEFAULT_PRIORITY);
        }
        ...
        !hidden && (0,_utils_draw__WEBPACK_IMPORTED_MODULE_25__.drawCircle)(_this6.dataLayers[legend].context, _this6.xRatio * x + padding.left + _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_INNER_PADDING, _this6.viewport.canvas.height / _this6.viewport.viewLayer.dpr - _this6.yRatio * y - padding.bottom - _constants_ui__WEBPACK_IMPORTED_MODULE_28__.AXIS_INNER_PADDING, {
    ...
    value: function setAxisOption(axisOption) {
      this.setOptions(lodash_merge__WEBPACK_IMPORTED_MODULE_21___default()(this.options, {
        axis: axisOption
      }));
      this.setPadding();
      this.setRatio();
    ...
    value: function toBase64Image() {
      ...
      var clonedViewPort = lodash_clonedeep__WEBPACK_IMPORTED_MODULE_22___default()(this.viewport);
      clonedViewPort.setSize(_constants_ui__WEBPACK_IMPORTED_MODULE_28__.CONTAINER_WIDTH, _constants_ui__WEBPACK_IMPORTED_MODULE_28__.CONTAINER_HEIGHT); // // [...Array.from(clonedLegend.getElementsByTagName('input'))].forEach((node) => {
      // //   console.log(node)
...
//# sourceMappingURL=main.a57680152b540d47b04b.hot-update.js.map