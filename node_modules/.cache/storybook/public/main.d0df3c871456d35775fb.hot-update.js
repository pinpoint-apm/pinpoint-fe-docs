...
var ScatterChart = /*#__PURE__*/function () {
  ...
  _createClass(ScatterChart, [{
    ...
    value: function setWidthAndHeight() {
      console.log('🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡');
      console.log(this.canvasWrapper.clientWidth);
      console.log(this.canvasWrapper.clientHeight);
      console.log('🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡');
    ...
    value: function resize(width, height) {
      ...
      console.log(this.canvasWrapper.clientHeight);
      console.log('🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡🤡');
      var w = width || this.canvasWrapper.clientWidth || _constants_ui__WEBPACK_IMPORTED_MODULE_27__.CONTAINER_WIDTH;
      var h = height || this.canvasWrapper.clientHeight || _constants_ui__WEBPACK_IMPORTED_MODULE_27__.CONTAINER_HEIGHT;
      console.log(w, h);
...
//# sourceMappingURL=main.d0df3c871456d35775fb.hot-update.js.map